...
aes_aes.add_array("sbox", 256, 1, mtype=SPAD)
...
bfs_queue.add_array("queue", 256, 8, mtype=SPAD)
...
fft_transpose.add_array("twiddles8.reversed8", 8, 4, ptype=COMPLETE)
...
fft_transpose.add_array("work_x", 512, 8, mtype=SPAD)
fft_transpose.add_array("work_y", 512, 8, mtype=SPAD)
