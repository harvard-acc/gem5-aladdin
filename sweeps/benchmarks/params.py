...
cache_line_sz = IntParam("cache_line_sz", 32)
tlb_hit_latency = IntParam("tlb_hit_latency", 0)
tlb_miss_latency = IntParam("tlb_miss_latency", 20)
tlb_page_size = IntParam("tlb_page_size", 4096)
tlb_entries = IntParam("tlb_entries", 0)
tlb_max_outstanding_walks = IntParam("tlb_max_outstanding_walks", 0)
tlb_assoc = IntParam("tlb_assoc", 0)
tlb_bandwidth = IntParam("tlb_bandwidth", 1)
load_bandwidth = IntParam("load_bandwidth", 1)
store_bandwidth = IntParam("store_bandwidth", 1)
