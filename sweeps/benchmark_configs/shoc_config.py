...
bb_gemm.add_loop("bb_gemm", "loopk", UNROLL_FLATTEN)
bb_gemm.add_loop("bb_gemm", "loopj", UNROLL_FLATTEN)
...
fft.add_loop("step1", "load", UNROLL_FLATTEN)
fft.add_loop("step1", "twiddles", UNROLL_FLATTEN)
fft.add_loop("step1", "store", UNROLL_FLATTEN)
fft.add_loop("step2", "outer")
fft.add_loop("step2", "load", UNROLL_FLATTEN)
fft.add_loop("step3", "outer")
fft.add_loop("step3", "load", UNROLL_FLATTEN)
fft.add_loop("step3", "store", UNROLL_FLATTEN)
fft.add_loop("step4", "outer")
fft.add_loop("step4", "load", UNROLL_FLATTEN)
fft.add_loop("step5", "outer")
fft.add_loop("step5", "load", UNROLL_FLATTEN)
fft.add_loop("step5", "store", UNROLL_FLATTEN)
fft.add_loop("step6", "outer")
fft.add_loop("step6", "load", UNROLL_FLATTEN)
fft.add_loop("step6", "twiddles", UNROLL_FLATTEN)
fft.add_loop("step6", "save", UNROLL_FLATTEN)
fft.add_loop("step7", "outer")
fft.add_loop("step7", "load", UNROLL_FLATTEN)
fft.add_loop("step8", "outer")
fft.add_loop("step8", "load", UNROLL_FLATTEN)
fft.add_loop("step8", "store", UNROLL_FLATTEN)
fft.add_loop("step9", "outer")
fft.add_loop("step9", "load", UNROLL_FLATTEN)
fft.add_loop("step10", "outer")
fft.add_loop("step10", "load", UNROLL_FLATTEN)
fft.add_loop("step10", "store", UNROLL_FLATTEN)
fft.add_loop("step11", "outer")
fft.add_loop("step11", "load", UNROLL_FLATTEN)
fft.add_loop("step11", "store", UNROLL_FLATTEN)
...
md.add_loop("md", "loop_j", UNROLL_FLATTEN)
...
pp_scan.add_loop("local_scan", "loop1_inner", UNROLL_FLATTEN)
pp_scan.add_loop("last_step_scan", "loop3_outer")
pp_scan.add_loop("last_step_scan", "loop3_inner", UNROLL_FLATTEN)
...
ss_sort.add_loop("hist", "loop1", UNROLL_FLATTEN)
ss_sort.add_loop("local_scan", "loop1_outer")
ss_sort.add_loop("local_scan", "loop1_inner", UNROLL_FLATTEN)
ss_sort.add_loop("sum_scan", "loop2")
ss_sort.add_loop("last_step_scan", "loop3_outer")
ss_sort.add_loop("last_step_scan", "loop3_inner", UNROLL_FLATTEN)
ss_sort.add_loop("update", "loop3")
ss_sort.add_loop("update", "loop1", UNROLL_FLATTEN)
...
stencil.add_loop("stencil", "inner", UNROLL_FLATTEN)
