...
fft_transpose.add_loop("fft1D_512", 179, 0)
fft_transpose.add_loop("fft1D_512", 209, 64)
fft_transpose.add_loop("fft1D_512", 223, 64)
fft_transpose.add_loop("fft1D_512", 239, 64)
fft_transpose.add_loop("fft1D_512", 254, 64)
fft_transpose.add_loop("fft1D_512", 279, 64)
fft_transpose.add_loop("fft1D_512", 306, 0)
fft_transpose.add_loop("fft1D_512", 337, 64)
fft_transpose.add_loop("fft1D_512", 352, 64)
fft_transpose.add_loop("fft1D_512", 368, 64)
fft_transpose.add_loop("fft1D_512", 383, 64)
fft_transpose.add_loop("fft1D_512", 408, 64)
